package io.github.surezzzzzz.sdk.ops.middleware.kafka.adapter;
...
import io.github.surezzzzzz.sdk.ops.middleware.kafka.consumer.lag.KafkaConsumerGroupLagResponse;
import io.github.surezzzzzz.sdk.ops.middleware.kafka.consumer.list.KafkaConsumerGroupListRequest;
import io.github.surezzzzzz.sdk.ops.middleware.kafka.consumer.list.KafkaConsumerGroupListResponse;
import io.github.surezzzzzz.sdk.ops.middleware.kafka.consumer.list.KafkaConsumerGroupResponse;
import io.github.surezzzzzz.sdk.ops.middleware.kafka.datasource.KafkaDatasourceListResponse;
import io.github.surezzzzzz.sdk.ops.middleware.kafka.datasource.KafkaDatasourceResponse;
...
import io.github.surezzzzzz.sdk.ops.middleware.kafka.topic.list.KafkaTopicListResponse;
import io.github.surezzzzzz.sdk.ops.middleware.kafka.topic.list.KafkaTopicResponse;
...
public class DefaultKafkaOperationsViewAdapter implements KafkaOperationsViewAdapter {
    ...
    private <T> T await(long deadlineNanos, org.apache.kafka.common.KafkaFuture<T> future) {
        ...
        try {
            ...
            future.cancel(true);
            throw new MiddlewareOpsException(HttpStatus.GATEWAY_TIMEOUT, "Kafka 运维查询已超时", e);
    ...
    private MiddlewareOpsException unavailable(Throwable cause) {
        return new MiddlewareOpsException(HttpStatus.SERVICE_UNAVAILABLE, "Kafka 运维查询暂不可用", cause);
    }
