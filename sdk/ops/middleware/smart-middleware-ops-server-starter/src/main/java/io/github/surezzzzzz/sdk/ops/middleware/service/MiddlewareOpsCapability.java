...
public enum MiddlewareOpsCapability {
    ...
    ELASTICSEARCH_FIELD_CAPABILITIES(MiddlewareType.ELASTICSEARCH),
    ...
    REDIS_KEY_DISCOVERY(MiddlewareType.REDIS),
    ...
    KAFKA_TOPIC_CONFIG(MiddlewareType.KAFKA),
    KAFKA_CONSUMER_GROUP_DETAIL(MiddlewareType.KAFKA),
    ...
    MYSQL_EXPLAIN(MiddlewareType.MYSQL),
    MYSQL_TABLE_LIST(MiddlewareType.MYSQL),
    MYSQL_TABLE_COLUMNS(MiddlewareType.MYSQL),
    MYSQL_TABLE_INDEXES(MiddlewareType.MYSQL);
