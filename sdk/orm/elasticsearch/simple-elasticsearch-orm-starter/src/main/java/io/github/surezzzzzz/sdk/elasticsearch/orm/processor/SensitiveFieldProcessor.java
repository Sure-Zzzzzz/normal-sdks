package io.github.surezzzzzz.sdk.elasticsearch.orm.processor;
...
public class SensitiveFieldProcessor {
     ...
     * 脱敏处理
     */
    private String maskValue(String value, SimpleElasticsearchOrmProperties.SensitiveFieldConfig config) {
    ...
    private SimpleElasticsearchOrmProperties.IndexConfig findIndexConfig(String identifier) {
        for (SimpleElasticsearchOrmProperties.IndexConfig config : mappingManager.getAllIndices()) {
            // 优先匹配alias（如果有）
