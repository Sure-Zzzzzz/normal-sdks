package io.github.surezzzzzz.sdk.elasticsearch.orm.endpoint.response;
...
public class IndexInfoResponse {
     ...
     * 从配置创建
     */
    public static IndexInfoResponse from(SimpleElasticsearchOrmProperties.IndexConfig config, MappingManager mappingManager) {
