...
CREATE USER IF NOT EXISTS '${E2E_OPS_READONLY_USERNAME}'@'%' IDENTIFIED BY '${E2E_OPS_READONLY_PASSWORD}';
CREATE USER IF NOT EXISTS '${E2E_AUDIT_READONLY_USERNAME}'@'%' IDENTIFIED BY '${E2E_AUDIT_READONLY_PASSWORD}';
...
GRANT SELECT ON test_ops.test_route_marker TO '${E2E_OPS_READONLY_USERNAME}'@'%';
GRANT SELECT ON test_audit.test_route_marker TO '${E2E_AUDIT_READONLY_USERNAME}'@'%';
FLUSH PRIVILEGES;
SQL
