...
public final class ErrorMessage {
    ...
    public static final String CREDENTIAL_RESOLVER_REQUIRED = "必须提供 MySQL Route 凭据解析器";
    public static final String CREDENTIAL_INVALID = "凭据解析器未返回有效凭据，clusterKey=[%s]";
    ...
    public static final String CLUSTER_CREDENTIAL_REF_REQUIRED =
            "cluster [%s] credential-ref 不能为空";
    ...
    public static final String DATASOURCE_KEY_REQUIRED = "datasourceKey 不能为空";
    public static final String DATASOURCE_CLUSTER_NOT_FOUND =
            "datasource [%s] 引用的 clusterKey 不存在";
    public static final String DATASOURCE_DATABASE_REQUIRED = "datasource [%s] database 不能为空";
    public static final String DATASOURCE_COMBINATION_DUPLICATE = "clusterKey + database 组合不能重复";
