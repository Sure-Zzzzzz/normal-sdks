...
public final class ErrorCode {
    ...
    // ========== 兼容公共能力相关 (ROUTE_COMPAT_xxx) ==========

    public static final String ROUTE_COMPAT_REFLECT_CLASS_NOT_FOUND = "ROUTE_COMPAT_REFLECT_CLASS_NOT_FOUND";
    public static final String ROUTE_COMPAT_REFLECT_METHOD_NOT_FOUND = "ROUTE_COMPAT_REFLECT_METHOD_NOT_FOUND";
    public static final String ROUTE_COMPAT_REFLECT_FIELD_NOT_FOUND = "ROUTE_COMPAT_REFLECT_FIELD_NOT_FOUND";
    public static final String ROUTE_COMPAT_REFLECT_CONSTRUCTOR_NOT_FOUND = "ROUTE_COMPAT_REFLECT_CONSTRUCTOR_NOT_FOUND";
    public static final String ROUTE_COMPAT_REFLECT_INVOKE_FAILED = "ROUTE_COMPAT_REFLECT_INVOKE_FAILED";
    public static final String ROUTE_COMPAT_XCONTENT_API_NOT_FOUND = "ROUTE_COMPAT_XCONTENT_API_NOT_FOUND";
    public static final String ROUTE_COMPAT_XCONTENT_REGISTRY_CREATE_FAILED = "ROUTE_COMPAT_XCONTENT_REGISTRY_CREATE_FAILED";
    public static final String ROUTE_COMPAT_XCONTENT_PARSE_FAILED = "ROUTE_COMPAT_XCONTENT_PARSE_FAILED";
    public static final String ROUTE_COMPAT_LOW_LEVEL_REQUEST_FAILED = "ROUTE_COMPAT_LOW_LEVEL_REQUEST_FAILED";
    public static final String ROUTE_COMPAT_RESPONSE_READ_FAILED = "ROUTE_COMPAT_RESPONSE_READ_FAILED";
    public static final String ROUTE_COMPAT_MAPPING_SOURCE_EXTRACT_FAILED = "ROUTE_COMPAT_MAPPING_SOURCE_EXTRACT_FAILED";
    public static final String ROUTE_COMPAT_JSON_SERIALIZE_FAILED = "ROUTE_COMPAT_JSON_SERIALIZE_FAILED";
