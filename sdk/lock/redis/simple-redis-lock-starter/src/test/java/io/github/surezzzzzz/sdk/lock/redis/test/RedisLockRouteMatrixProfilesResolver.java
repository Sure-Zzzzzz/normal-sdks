...
/**
 * redis-lock route matrix profile 解析器。
 *
 * @author surezzzzzz
 */
public class RedisLockRouteMatrixProfilesResolver implements ActiveProfilesResolver {
    ...
    public String[] resolve(Class<?> testClass) {
        ...
        for (String profile : profiles) {
            ...
            if ("2.7.9".equals(versionProfile) || "2.4.5".equals(versionProfile)
                ...
                return new String[]{"redis-lock-route-matrix", versionProfile, "redis-lock-route-matrix-" + versionProfile};
            }
        }
        return new String[]{"redis-lock-route-matrix"};
    }
