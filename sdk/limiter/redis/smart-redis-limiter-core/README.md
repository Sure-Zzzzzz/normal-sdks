...
[![Version](https://img.shields.io/badge/version-1.1.4-blue.svg)](https://github.com/Sure-Zzzzzz/normal-sdks)
...
```gradle
implementation 'io.github.sure-zzzzzz:smart-redis-limiter-core:1.1.4'
```
