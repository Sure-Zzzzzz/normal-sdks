...
public class SmartRedisLimiterKeyProviderStartupTest {
    ...
    public void testInitFailsWhenKeyProviderBeanMissing() {
        ...
        SmartRedisLimiterConfigurationException ex =
                assertThrows(SmartRedisLimiterConfigurationException.class, interceptor::init);
        assertEquals(ErrorCode.KEY_PROVIDER_INVALID,
                ex.getErrorCode(), "错误码应为 KeyProvider 配置错误");
    ...
    public void testInitSkipsValidationWhenInterceptorDisabled() {
        ...
        log.info("拦截器模式未启用，ApplicationContext 不应参与 KeyProvider 校验");
