...
public class SmartLimiterWebTest {
    ...
    public void testRedisKeyStructure() throws Exception {
        ...
        // 清空之前的key
        Set<String> oldKeys = redisRouteTemplate.stringTemplate().keys(SmartRedisLimiterRedisKeyConstant.KEY_PREFIX + "*");
        if (oldKeys != null && !oldKeys.isEmpty()) {
            redisRouteTemplate.stringTemplate().delete(oldKeys);
        ...
        // 立即检查GET的key
        Set<String> keysAfterGet = redisRouteTemplate.stringTemplate().keys(SmartRedisLimiterRedisKeyConstant.KEY_PREFIX + "*");
        ...
        for (String key : keys) {
            ...
            Long ttl = redisRouteTemplate.stringTemplate().getExpire(key, java.util.concurrent.TimeUnit.SECONDS);
