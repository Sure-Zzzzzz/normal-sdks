    ...
    public Map<String, String> getAll() {
        ...
        try {
            ...
            if (authentication != null && authentication.getPrincipal() instanceof Jwt) {
                ...
                String clientType = jwt.getClaimAsString(SimpleAkskResourceConstant.JWT_CLAIM_CLIENT_TYPE);
                if (clientType != null) {
                    context.put(SimpleAkskResourceConstant.FIELD_CLIENT_TYPE, clientType);
                }
            }
        } catch (Exception e) {
