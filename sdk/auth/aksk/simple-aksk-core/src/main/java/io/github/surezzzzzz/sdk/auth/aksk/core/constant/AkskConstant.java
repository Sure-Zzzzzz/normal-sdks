...
public final class AkskConstant {
     ...
     * AKSK资源认证来源标识。
     */
    public static final String RESOURCE_AUTHENTICATION_SOURCE_ID = "aksk";
    /**
     * 路由键分隔符。
     */
     ...
     * 路由密钥标识允许字符。
     */
    public static final String ROUTE_KEY_ID_ALLOWED_CHARACTER_PATTERN = "[A-Za-z0-9._-]+";
    /**
     * 路由密钥标识最大Unicode码点数。
     */
    public static final int MAX_ROUTE_KEY_ID_CODE_POINT_COUNT = 128;
