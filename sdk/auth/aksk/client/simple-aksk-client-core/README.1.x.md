# Simple AKSK Client Core 1.x 封版文档

> **说明**：此文档为 1.x 版本（1.0.1）的冻结快照。2.0.0 文档请查看 [README.md](README.md)。
...
```gradle
implementation 'io.github.sure-zzzzzz:simple-aksk-client-core:1.0.1'
```
