...
```gradle
implementation 'io.github.sure-zzzzzz:simple-aksk-resource-server-starter:1.0.3'
...
|-----------------------------------------|--------------------------------------------|-----------|
| `enabled`                               | 是否启用                                       | true      |
| `verification-mode`                     | 验证模式：`JWT` 或 `INTROSPECT`（推荐 `INTROSPECT`） | JWT       |
