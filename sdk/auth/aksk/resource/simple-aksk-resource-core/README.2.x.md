# Simple AKSK Resource Core（2.x 封版）
...
1. **统一抽象**：通过 `SimpleAkskSecurityContextProvider` 接口统一上下文获取方式
...
```gradle
dependencies {
    implementation 'io.github.sure-zzzzzz:simple-aksk-resource-core:2.0.0'
}
```
