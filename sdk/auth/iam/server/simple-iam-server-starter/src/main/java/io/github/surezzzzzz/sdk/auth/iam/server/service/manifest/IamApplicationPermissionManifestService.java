package io.github.surezzzzzz.sdk.auth.iam.server.service.manifest;
...
public class IamApplicationPermissionManifestService {
    ...
    private void validateMenuPagePermissionReferences(Long applicationId, List<String> pagePermissions) {
        ...
        for (io.github.surezzzzzz.sdk.auth.iam.server.entity.portal.IamTrustedApplicationMenuEntity menu
