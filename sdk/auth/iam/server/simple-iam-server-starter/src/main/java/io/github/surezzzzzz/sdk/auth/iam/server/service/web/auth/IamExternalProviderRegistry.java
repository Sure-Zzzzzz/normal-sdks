 ...
 * @author surezzzzzz
 */
public final class IamExternalProviderRegistry {
    ...
    private IamExternalProviderRegistry(Map<String, ExternalCredentialAuthenticator> credentialAuthenticators,
     ...
     * @return 外部登录方式注册表
     */
    public static IamExternalProviderRegistry create(
        ...
        return new IamExternalProviderRegistry(byCode, byBrowserCode);
    }
