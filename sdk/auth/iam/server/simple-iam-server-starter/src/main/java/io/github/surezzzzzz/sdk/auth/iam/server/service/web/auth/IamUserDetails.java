 ...
 * IamUserDetailsMixin 的 JSON 契约逐一对齐。</p>
 *
 * @author surezzzzzz
 */
public class IamUserDetails implements UserDetails, CredentialsContainer, Serializable {
    ...
    private IamUserDetails(Long userId, String username, String password,
     ...
     * 以用户实体 + 角色编码构造登录主体
     */
    public static IamUserDetails of(IamUserEntity user,
                                    Collection<? extends GrantedAuthority> authorities) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IamUserDetails)) {
            return false;
        }
        return Objects.equals(userId, ((IamUserDetails) o).userId);
    }
