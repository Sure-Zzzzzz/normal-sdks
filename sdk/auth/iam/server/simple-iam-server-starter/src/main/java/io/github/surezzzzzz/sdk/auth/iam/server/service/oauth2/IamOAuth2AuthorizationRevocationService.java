 ...
 *
 * <p>绑定会话的 refresh token 已由 IamCachedOAuth2AuthorizationService 的
...
public class IamOAuth2AuthorizationRevocationService {
     ...
     */
    private final IamRefreshTokenFamilyService refreshTokenFamilyService;

    /**
     * 延迟解析打断构造环：IamCachedOAuth2AuthorizationService 构造依赖 IamSessionService，
     * 而 IamSessionService 依赖本类。
     */
