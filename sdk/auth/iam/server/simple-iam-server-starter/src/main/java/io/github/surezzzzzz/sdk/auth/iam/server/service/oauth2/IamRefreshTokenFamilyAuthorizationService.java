 ...
 * 本装饰器把 {@link IamRefreshTokenFamilyService} 的族表接到 SAS 授权生命周期上：</p>
 *
 * <ul>
 ...
 *       {@link IamOAuth2AuthorizationRevocationService} 传导）</li>
 * </ul>
 *
...
public class IamRefreshTokenFamilyAuthorizationService implements OAuth2AuthorizationService {
     ...
     * 整族吊销并发布事件（{@link IamRefreshTokenFamilyService#detectReuseAndRevoke}）。
     */
