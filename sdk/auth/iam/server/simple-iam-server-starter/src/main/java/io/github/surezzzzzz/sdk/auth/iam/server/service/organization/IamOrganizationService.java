package io.github.surezzzzzz.sdk.auth.iam.server.service.organization;
...
import io.github.surezzzzzz.sdk.auth.iam.server.repository.department.IamDepartmentMemberCount;
...
public class IamOrganizationService {
    ...
    public List<OrganizationTreeNodeResponse> getTree() {
        ...
        Map<Long, Long> memberCounts = userRepository.countDirectMembersByDepartment().stream()
                .collect(Collectors.toMap(IamDepartmentMemberCount::getDepartmentId,
                        IamDepartmentMemberCount::getMemberCount));
